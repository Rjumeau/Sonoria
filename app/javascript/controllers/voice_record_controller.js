...
export default class extends Controller {
  static targets = [
    'microphone', 'voiceInstructions', 'playInstructions', 'minimalVoiceInstructions', 'stopButton', 'elapsedTimeTag',
  ...
  startAudioRecording() {
    ...
    console.log('Display voice instructions...')
    this.displayVoiceInstructions();
  ...
  */
  ...
  displayVoiceInstructions() {
    this.voiceInstructionsTarget.classList.remove('hidden')
    this.minimalVoiceInstructionsTarget.classList.add('hidden')
  }
